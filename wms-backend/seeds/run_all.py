...
SYSTEM_PERMISSIONS = [
    ...
    ("inbound:grn:approve",      "Aprobar GRN",              "inbound"),
    ("inbound:putaway:execute",  "Ejecutar Putaway",         "inbound"),
...
SYSTEM_ROLES = {
    ...
    "Supervisor de Bodega": {
        ...
        "permissions": [
            ...
            "inbound:po:read", "inbound:grn:create", "inbound:grn:approve", "inbound:putaway:execute",
    ...
    "Operador de Bodega": {
        ...
        "permissions": [
            "inventory:read",
            "inbound:po:read", "inbound:grn:create", "inbound:putaway:execute",
